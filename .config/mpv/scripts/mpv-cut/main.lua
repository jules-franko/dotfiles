...
ACTIONS.COPY = function(d)
	local args = {
		...
		utils.join_path(home_dir, "COPY_" .. d.channel .. "_" .. d.infile_noext .. "_FROM_" .. d.start_time_hms .. "_TO_" .. d.end_time_hms .. d.ext)
	}
...
ACTIONS.ENCODE = function(d)
	local args = {
		...
		"-crf", "16",
		"-preset", "superfast",
		utils.join_path(home_dir, "ENCODE_" .. d.channel .. "_" .. d.infile_noext .. "_FROM_" .. d.start_time_hms .. "_TO_" .. d.end_time_hms .. d.ext)
	}
	mp.command_native_async({
		name = "subprocess",
		args = args,
